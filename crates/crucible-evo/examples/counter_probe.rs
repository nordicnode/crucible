...
use crucible_sim::{GameConfig, UnitType, TICKS_PER_SEC};
...
fn main() {
    ...
    println!("medium>easy p50: {}s", median(medium_easy) / TICKS_PER_SEC);
    println!("hard>medium p50: {}s", median(hard_medium) / TICKS_PER_SEC);
}
